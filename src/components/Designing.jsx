...
export default function Designing() {
    ...
    const [brezzaColor, setBrezzaColor] = useState('');
    ...
    return (<>
        <motion.div initial={{ opacity: 0 }}
            ...
            <div className={`pb-5 px-5 md:pb-11 mt-5 grid gap-5 rounded-3xl w-full ${toggled ? 'bg-dark24' :
                ...
                <div className="brezza">
                    <div className="car-image px-11 w-full h-min">
                        <img src="https://github.com/navalrathore10/Portfolio-Dashboard/blob/main/public/img/brezza.png?raw=true"
                            alt="" width={'100%'}
                            className={`
                            ${brezzaColor == 'blue' ? 'hue-rotate-[575deg]' :
                                    brezzaColor == 'green' ? 'hue-rotate-[85deg]' :
                                        brezzaColor == 'pink' ? 'hue-rotate-[295deg]' :
                                            'hue-rotate-[0deg]'
                                }
                    ...
                    <div className="bnts flex gap-2 justify-center mt-5">
                        <button className=' w-5 h-5 md:w-10 md:h-10 border-2 border-white rounded-full bg-[rgb(0_62_169)] 155 hover:w-14  duration-300 transition-ease-in'
                            onClick={() => { setBrezzaColor('blue') }}
                        ></button>
                        <button className=' w-5 h-5 md:w-10 md:h-10 border-2 border-white rounded-full bg-[#337100] 105 hover:w-14  duration-300 transition-ease-in'
                            onClick={() => { setBrezzaColor('green') }}
                        ></button>
                        <button className=' w-5 h-5 md:w-10 md:h-10 border-2 border-white rounded-full bg-[#a019b1] 295 hover:w-14  duration-300 transition-ease-in'
                            onClick={() => { setBrezzaColor('pink') }}
                        ></button>
                        <button className=' w-5 h-5 md:w-10 md:h-10 border-2 border-white rounded-full bg-[#ca0000] 0 hover:w-14  duration-300 transition-ease-in'
                            onClick={() => { setBrezzaColor('orange') }}
                        ></button>
                    </div>
                </div>
            </div>

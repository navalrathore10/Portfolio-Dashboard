...
import floralCard from '../assets/img/floral-card.png';
...
export default function Development() {
    ...
    useLayoutEffect(() => {
        // Apply theme changes here based on the toggled state
        document.body.className = toggled ? 'dark-mode' : 'light-mode';
    }, [toggled]);
    ...
    return (
        <motion.div initial={{ opacity: 0 }}
            ...
            <div className="h-min w-full relative z-20">
                <div className={`relative z-20 h-min pb-[20px] mt-5 rounded-3xl w-full p-5 ${toggled ? 'bg-dark17 text-lighte3' : 'bg-lighte3 text-dark24'} overflow-hidden`}>
                    ...
                    <div className="projects flex flex-col gap-5">
                        ...
                        <div id='project1' className="relative w-full h-[250px] flex justify-center items-center border-black">
                            ...
                            <div className={`relative btnclick text-mazit p-1 text-3xl sm:text-4xl lg:text-5xl rounded-full border border-black w-min shadow-lg cursor-pointer mx-auto
                            ${toggled ? 'hover:text-dark24 hover:bg-lighte3 border-lightop20' : 'hover:text-lighte3 hover:bg-dark24 border-darkop40'}`}
                                ...
                                {/* <div className="absolute z-10 transform -translate-x-[18%] -translate-y-[28%] w-[400px] h-[200px] border border-black">
                                    <img src={floralCard} width={"100%"} height={"100%"} className='transform -translate-y-[20%]' alt="" />
                                </div> */}
                                <div className={`relative z-10 px-11 py-5 rounded-full border  shadow-lg
                ...
                <Link to={"../../Explorations"}>
                    <motion.div
                        ...
                        className={`z-10 absolute w-[100px] h-[200px] ${toggled ? 'bg-darkop40' : 'bg-lightop10'} 
                            -right-[50px] top-[50px] rounded-[0px_20px_20px_0px]
                            flex items-center`}>
                        <div className="rotate-90 text-2xl text-syne ">Components</div>
                    </motion.div>
                </Link>
            </div>
        </motion.div>
